...
describe("PlaceOrderUseCase", () => {
	...
	describe("execute method", () => {
		...
		describe("place an order", () => {
			...
			placeOrderUseCase["clientFacade"] = mockClientFacade as any;
			placeOrderUseCase["paymentFacade"] = mockPaymentFacade as any;
			placeOrderUseCase["invoiceFacade"] = mockInvoiceFacade as any;
